...
var AbstractControl = class {
  ...
  get(path) {
    ...
    return currPath.reduce((control, name3) => control && control._find(name3), this);
  }
  /**
   * @description
   * Reports error data for the control with the given path.
...
var FormGroup = class extends AbstractControl {
  ...
  controls;
  registerControl(name3, control) {
    if (this.controls[name3]) return this.controls[name3];
    this.controls[name3] = control;
    control.setParent(this);
    control._registerOnCollectionChange(this._onCollectionChange);
    return control;
  }
  addControl(name3, control, options = {}) {
    this.registerControl(name3, control);
    this.updateValueAndValidity({
   ...
   */
  removeControl(name3, options = {}) {
    if (this.controls[name3]) this.controls[name3]._registerOnCollectionChange(() => {
    });
    delete this.controls[name3];
    this.updateValueAndValidity({
      emitEvent: options.emitEvent
    });
    this._onCollectionChange();
  }
  setControl(name3, control, options = {}) {
    if (this.controls[name3]) this.controls[name3]._registerOnCollectionChange(() => {
    });
    delete this.controls[name3];
    if (control) this.registerControl(name3, control);
    this.updateValueAndValidity({
      emitEvent: options.emitEvent
    });
    this._onCollectionChange();
  ...
  setValue(value, options = {}) {
    ...
    Object.keys(value).forEach((name3) => {
      assertControlPresent(this, true, name3);
      this.controls[name3].setValue(value[name3], {
        onlySelf: true,
        emitEvent: options.emitEvent
      });
    });
  ...
  patchValue(value, options = {}) {
    ...
    Object.keys(value).forEach((name3) => {
      const control = this.controls[name3];
      if (control) {
        control.patchValue(
   ...
   */
  reset(value = {}, options = {}) {
    this._forEachChild((control, name3) => {
      control.reset(value ? value[name3] : null, {
        onlySelf: true,
        emitEvent: options.emitEvent
      });
    });
   ...
   */
  getRawValue() {
    return this._reduceChildren({}, (acc, control, name3) => {
      acc[name3] = control.getRawValue();
      return acc;
    });
  }
  /** @internal */
  ...
  _reduceValue() {
    let acc = {};
    return this._reduceChildren(acc, (acc2, control, name3) => {
      if (control.enabled || this.disabled) {
        acc2[name3] = control.value;
      }
      return acc2;
    });
  }
  ...
  /** @internal */
  _find(name3) {
    return this.controls.hasOwnProperty(name3) ? this.controls[name3] : null;
  }
};
...
function controlPath(name3, parent) {
  return [...parent.path, name3];
}
...
function _ngModelWarning(name3, type, instance, warningConfig) {
  if (warningConfig === "never") return;
  if ((warningConfig === null || warningConfig === "once") && !type._ngModelWarningSentOnce || warningConfig === "always" && !instance._ngModelWarningSent) {
    console.warn(ngModelWarning(name3));
...
function checkParentType(parent, name3) {
  if (!(parent instanceof FormGroupName) && parent instanceof AbstractFormGroupDirective) {
    throw ngModelGroupException();
  } else if (!(parent instanceof FormGroupName) && !(parent instanceof FormGroupDirective) && !(parent instanceof FormArrayName)) {
    throw controlParentException(name3);
  }
}
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EWRGETIS.js.map
