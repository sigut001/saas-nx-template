        ...
        if (!(k < 3) && (k != 3 || this.g && (this.h.h || this.g.la() || Ib(this.g)))) {
          ...
          if (this.o) {
            ...
            if (this.R) {
              ...
              this.o = this.o && a;
              if (!a) K(this.i, this.l, c, "[Invalid Chunked Response]"), Q2(this), Mb(this);
...
var __PRIVATE_LruScheduler = class {
  ...
  Ar(e) {
    __PRIVATE_logDebug(Ct, `Garbage collection scheduled in ${e}ms`), this.Rr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Rr = null;
      try {
        ...
        yield function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds)
              e2.Ia.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.Ia.delete(r), e2.da.removeTarget(r));
          });
        }(e, t);
      } catch (n2) {
...
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    e.asyncQueue.enqueueRetryable(() => __async(null, null, function* () {
      __PRIVATE_logDebug(Ht, "Retrying IndexedDB access"), yield n(), e.Ea.delete(
        1
        /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  }), e.Ra.push((t) => __async(null, null, function* () {
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.fa = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.fa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(Ht, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
  }))), e.fa;
}
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r.Pu.J_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
@firebase/firestore/dist/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IBA3O5CQ.js.map
