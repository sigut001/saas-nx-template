...
var SAAS_CONFIG = {
  ...
  features: {
    // ─── Auth-Features ──────────────────────────────────────────────────
    publicSignup: true,
    // false → /register deaktiviert + Link weg
    googleLogin: true,
    // false → Google-Button ausgeblendet
    emailLogin: true,
    // false → nur Social Login
    inviteOnly: false,
    // true → Signup nur via /invite/:token
    passwordReset: true,
    // false → "Passwort vergessen" Link weg
    emailVerification: true,
    // false → keine Verifikationsmail
    // ─── Multi-Tenancy ──────────────────────────────────────────────────
    multiOrganization: false,
    // true → B2B: Org-Wizard, Mitglieder, Switcher
    onboarding: false,
    // true → Org-Wizard nach Registrierung (nur wenn multiOrg: true)
    invitations: false,
    // true → Mitglieder per E-Mail einladen
    // ─── App-Bereiche ───────────────────────────────────────────────────
    billing: true,
    // false → /pricing + /billing deaktiviert
    adminPanel: true,
    // false → /admin/** komplett deaktiviert
    notifications: false,
    // true → Notification Bell in Top-Bar
    trialDays: 0
    // > 0 → Trial-Zeitraum in Tagen
  },
  legal: {
...
// apps/web/src/app/core/guards/onboarding.guard.ts
var onboardingGuard = () => __async(null, null, function* () {
  ...
  try {
    ...
    const userDoc = yield getDoc(doc(db, "users", user.uid));
    if (!userDoc.exists()) {
      return true;
    }
...
var f = SAAS_CONFIG.features;
var appCanActivate = f.multiOrganization ? [authGuard, onboardingGuard] : [authGuard];
var appRoutes = [
  // ─── Auth Zone ──────────────────────────────────────────────────────────
  {
    path: "login",
    loadComponent: () => import("./chunk-PMGTWKK5.js").then((m) => m.LoginComponent)
  },
  ...f.publicSignup && !f.inviteOnly ? [{
    path: "register",
    loadComponent: () => import("./chunk-PMGTWKK5.js").then((m) => m.RegisterComponent)
  }] : [],
  ...f.passwordReset ? [{
    path: "forgot-password",
    loadComponent: () => import("./chunk-PMGTWKK5.js").then((m) => m.ForgotPasswordComponent)
  }] : [],
  // ─── Onboarding (nur wenn multiOrganization: true) ──────────────────────
  ...f.multiOrganization ? [{
    path: "onboarding",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-XLWZVS6W.js").then((m) => m.OnboardingComponent)
  }] : [],
  // ─── Root ───────────────────────────────────────────────────────────────
  {
    path: "",
    loadComponent: () => import("./chunk-JTRY5JBW.js").then((m) => m.HomeComponent)
  },
  // ─── App Zone ───────────────────────────────────────────────────────────
  {
    path: "app",
    canActivate: appCanActivate,
    loadComponent: () => import("./chunk-VG6STV6K.js").then((m) => m.AppShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        title: "Dashboard",
        loadComponent: () => import("./chunk-CIEKY2WE.js").then((m) => m.DashboardComponent)
      },
      {
        path: "account",
        title: "Account",
        loadComponent: () => import("./chunk-WNM2VNWU.js").then((m) => m.AccountComponent)
      },
      {
        path: "settings",
        title: "Settings",
        loadComponent: () => import("./chunk-PSXB4TMX.js").then((m) => m.SettingsComponent)
      },
      ...f.billing ? [{
        path: "billing",
        title: "Billing",
        loadComponent: () => import("./chunk-KSOECRB3.js").then((m) => m.BillingComponent)
      }] : [],
      ...f.multiOrganization ? [{
        path: "organization",
        title: "Organization",
        loadComponent: () => import("./chunk-2ORTDPSO.js").then((m) => m.OrganizationComponent)
      }] : []
    ]
  },
  ...
  ...f.adminPanel ? [{
    ...
    loadComponent: () => import("./chunk-5MDXYJHO.js").then((m) => m.AdminShellComponent),
    children: [
      { path: "", redirectTo: "users", pathMatch: "full" },
      {
        path: "users",
        title: "Admin \u2013 Users",
        loadComponent: () => import("./chunk-TUOMYRUW.js").then((m) => m.AdminUsersComponent)
      }
    ]
  }] : [],
  // ─── 404 ────────────────────────────────────────────────────────────────
  {
    path: "**",
    loadComponent: () => import("./chunk-AMBQDGMG.js").then((m) => m.NotFoundComponent)
  }
];
...
var environment = {
  production: false,
  firebase: {
    apiKey: "AIzaSyBv3uQqb7z5OSggcpm8GZMCRPWPm6rAzCM",
    authDomain: "saas-example-94204.firebaseapp.com",
    projectId: "saas-example-94204",
    storageBucket: "saas-example-94204.firebasestorage.app",
    messagingSenderId: "230271632197",
    appId: "1:230271632197:web:b9760427fb92456b4e742c",
    measurementId: "G-C55CSEEZYY"
  },
  stripe: {
    publicKey: "pk_test_51TCfF54JZDxnVZhwpsGat97ZP1rRM2GckoyCZk1ynJ8guh5vf7no8yNiCKXKnJd6Z1PWacEzhVgkUNd7XNGkSV3J00JkQalFRT"
  }
};
