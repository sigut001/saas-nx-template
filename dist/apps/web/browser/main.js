...
// apps/web/src/app/guards/admin.guard.ts
var adminGuard = () => {
  const router = inject(Router);
...
var appRoutes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-O5JYAI6D.js").then((m) => m.AuthShellComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-ZEUN7WRQ.js").then((m) => m.LoginComponent)
      }
    ]
  },
  ...
  {
    path: "app",
    loadComponent: () => import("./chunk-FST6Z7S4.js").then((m) => m.AppShellComponent),
    ...
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        title: "Dashboard",
        loadComponent: () => import("./chunk-NJYR5BTR.js").then((m) => m.DashboardComponent)
      },
      {
        path: "account",
        title: "Account",
        loadComponent: () => import("./chunk-3LRR5DST.js").then((m) => m.AccountComponent)
      },
      {
        path: "settings",
        title: "Settings",
        loadComponent: () => import("./chunk-55Z5PNQW.js").then((m) => m.SettingsComponent)
      },
      {
        path: "billing",
        title: "Billing",
        loadComponent: () => import("./chunk-MPLP7HQL.js").then((m) => m.BillingComponent)
      },
      {
        path: "organization",
        title: "Organization",
        loadComponent: () => import("./chunk-TNN46LT5.js").then((m) => m.OrganizationComponent)
      }
  ...
  {
    path: "admin",
    loadComponent: () => import("./chunk-OPWE5OH7.js").then((m) => m.AdminShellComponent),
    ...
    children: [
      { path: "", redirectTo: "users", pathMatch: "full" },
      {
        path: "users",
        title: "Admin \u2013 Users",
        loadComponent: () => import("./chunk-L7NE3HIE.js").then((m) => m.AdminUsersComponent)
      }
    ]
  },
  // ─── 404 ──────────────────────────────────────────────────────────────────
  {
    path: "**",
    loadComponent: () => import("./chunk-RZWATTIL.js").then((m) => m.NotFoundComponent)
  }
];
